...
import { getFrontPagePost } from '@api/post.api';
  ...
  return (
    <div className="flex justify-center flex-col flex-1 gap-2 h-min pl-2">
      <div className="relative flex flex-row xl:flex-col gap-2 justify-between w-full z-[2]">
        ...
        <p className="font-playfair bigger-screen__secondary-text text-gray-600 w-5/6 hidden xl:block">
          {cutoff(secondaryText, 180)}
        </p>
      </div>
      <div className="relative z-[1] w-full aspect-[4/3] overflow-hidden group">
        <img
          className="object-cover w-full aspect-[4/3] group-hover:scale-110 transition-all"
          src={thumbnailUrl}
